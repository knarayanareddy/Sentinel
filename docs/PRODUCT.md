...
SENTINEL is an enterprise document agent, reasoning via Qwen models and retrieving via VultronRetriever
...
with full signal transparency including which model
...
3. Why (three signals, each attributed to a specific model)
